...
| ID | Subject |
|---|---|
| [§AR-001-ci](AR-001-ci.md#ar-001-ci-ci-mirrors-the-local-quality-gate-and-records-performance) | CI mirrors the local quality gate and records performance |
| [§AR-002-instruction-benchmarks](AR-002-instruction-benchmarks.md#ar-002-instruction-benchmarks-instruction-counting-benchmarks-for-hot-library-paths) | Instruction-counting benchmarks for hot library paths |
